...
function passWordShow(){
    ...
    var thisEle = document.getElementsByClassName('weui_grid');

    for (var i=0;i<thisEle.length;i++){

        thisEle[i].addEventListener('touchstart',function () {

            var square = document.getElementById('pasdBox').getElementsByTagName('span');

            var numBox = document.getElementById('numBox').getElementsByTagName('span');

            for (var i=0;i<thisInnerNum.length;i++){
...
/*弹出数字键盘*/
/*var hkbkeybroad = new hkbpswKeybroad.keyBroadShow({
