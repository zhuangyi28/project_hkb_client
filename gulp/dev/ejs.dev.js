    ...
    gulp.src('src/view/*/**.{ejs,html}')
        ...
        .pipe(cheerio({
                ...
                run:function ($) {
                    ...
                    addHtml += "<link rel='stylesheet'  href='../../css/hkbMain.css'/>\n ";//框架
        ...
        .pipe(cheerio(function ($) {
            ...
            var addJsRun = "<script src='../../js/hkbMain.js'></script>\n";//运行的脚本
            ...
            $('script').each(function (index, ele) {
                ...
                if ($(this).attr('src')) {
                    ...
                    if(thisAttr.indexOf('hkbMain.min.js')>-1){

                        thisAttr=thisAttr.replace('hkbMain.min.js','hkbMain.js')
